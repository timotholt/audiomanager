            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button
                        ...
                        sx={
                            (deleteConfirmName() !== projectToDelete()?.name || deleting())
                                ? {}
                                : {
                                    boxShadow: '0px 5px 5px -3px rgba(0,0,0,0.2),0px 8px 10px 1px rgba(0,0,0,0.14),0px 3px 14px 2px rgba(0,0,0,0.12)', // Shadow 8
                                    '&:hover': {
                                        boxShadow: '0px 3px 5px -1px rgba(0,0,0,0.2),0px 6px 10px 0px rgba(0,0,0,0.14),0px 1px 18px 0px rgba(0,0,0,0.12)', // Shadow 6
                                    },
                                    '&:active': {
                                        boxShadow: '0px 3px 1px -2px rgba(0,0,0,0.2),0px 2px 2px 0px rgba(0,0,0,0.14),0px 1px 5px 0px rgba(0,0,0,0.12)', // Shadow 2
                                    }
                                }
                        }
                    >
